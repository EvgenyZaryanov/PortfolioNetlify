      ...
      <div className={styles.profile__content}>
        <div className={styles.profile__info}>
          ...
          <p className={`${styles.profile__description} ${styles.paragraph1}`}>
            <b>Р</b>одился и живу в Москве, за плечами оконченное высшее образование МГУ, программа
            профессиональной переподготовки по веб-разработке, дополнительные курсы по смежным
            технологиям и интерактивные тренажеры. Есть опыт коммерческой разработки.
          </p>
